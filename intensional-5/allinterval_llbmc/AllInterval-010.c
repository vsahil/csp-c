...
if((var10 >= 1) & (var10 <= 9)) {myvar0= 1;}
else {exit(0);}
int var11;
var11 = __llbmc_nondef_int();
if((var11 >= 1) & (var11 <= 9)) {myvar0= 1;}
else {exit(0);}
int var12;
var12 = __llbmc_nondef_int();
if((var12 >= 1) & (var12 <= 9)) {myvar0= 1;}
else {exit(0);}
int var13;
var13 = __llbmc_nondef_int();
if((var13 >= 1) & (var13 <= 9)) {myvar0= 1;}
else {exit(0);}
int var14;
var14 = __llbmc_nondef_int();
if((var14 >= 1) & (var14 <= 9)) {myvar0= 1;}
else {exit(0);}
int var15;
var15 = __llbmc_nondef_int();
if((var15 >= 1) & (var15 <= 9)) {myvar0= 1;}
else {exit(0);}
int var16;
var16 = __llbmc_nondef_int();
if((var16 >= 1) & (var16 <= 9)) {myvar0= 1;}
else {exit(0);}
int var17;
var17 = __llbmc_nondef_int();
if((var17 >= 1) & (var17 <= 9)) {myvar0= 1;}
else {exit(0);}
int var18;
var18 = __llbmc_nondef_int();
if((var18 >= 1) & (var18 <= 9)) {myvar0= 1;}
else {exit(0);}
