...
int myvar0 = 1;
if(((var0 >= 0 & var0 <= 6) & (var1 >= 0 & var1 <= 6) & (var2 >= 0 & var2 <= 6) & (var3 >= 0 & var3 <= 6) & (var4 >= 0 & var4 <= 6) & (var5 >= 0 & var5 <= 6) & (var6 >= 0 & var6 <= 6) & (var7 >= 1 & var7 <= 6) & (var8 >= 1 & var8 <= 6) & (var9 >= 1 & var9 <= 6) & (var10 >= 1 & var10 <= 6) & (var11 >= 1 & var11 <= 6) & (var12 >= 1 & var12 <= 6) &  1))
myvar0 = 1;
else exit(0);
if(( 1))
myvar0 = 1;
...
if(((var7 == dist(var0, var1)) & (var8 == dist(var1, var2)) & (var9 == dist(var2, var3)) & (var10 == dist(var3, var4)) & (var11 == dist(var4, var5)) & (var12 == dist(var5, var6)) &  1))
myvar0 = 1;
else exit(0);
assert(0);
return 0;
