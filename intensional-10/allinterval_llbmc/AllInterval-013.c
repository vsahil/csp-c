...
__llbmc_assume(((var13 == dist(var0, var1)) & (var14 == dist(var1, var2)) & (var15 == dist(var2, var3)) & (var16 == dist(var3, var4)) & (var17 == dist(var4, var5)) & (var18 == dist(var5, var6)) & (var19 == dist(var6, var7)) & (var20 == dist(var7, var8)) & (var21 == dist(var8, var9)) & (var22 == dist(var9, var10)) & (var23 == dist(var10, var11)) & (var24 == dist(var11, var12)) &  1));
assert(0);
return 0;
/* 
0 x[0]
