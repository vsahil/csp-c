...
__llbmc_assume(((var11 == dist(var0, var1)) & (var12 == dist(var1, var2)) & (var13 == dist(var2, var3)) & (var14 == dist(var3, var4)) & (var15 == dist(var4, var5)) & (var16 == dist(var5, var6)) & (var17 == dist(var6, var7)) & (var18 == dist(var7, var8)) & (var19 == dist(var8, var9)) & (var20 == dist(var9, var10)) &  1));
assert(0);
return 0;
/* 
0 x[0]
